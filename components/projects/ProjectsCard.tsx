...
const ProjectsCard = ({
  ...
  return (
    <div className="group overflow-hidden relative hover:bg-black w-full h-[15rem] hover:shadow-md hover:shadow-gray-600 hover:translate-y-[-2px] mx-auto rounded-lg dark:bg-gray-800 dark:border-gray-700">
