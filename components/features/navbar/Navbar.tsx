...
const Navbar = () => {
  ...
  return (
    <div
      className={`${
        isScrolled
          ? "fixed top-0 h-[52px] left-0 w-full z-[100] py-2 md:flex md:items-center border-opacity-50 dark:border-opacity-5 bg-white dark:bg-gray-900 shadow-md bg-opacity-100 transition-all duration-300 ease-in"
