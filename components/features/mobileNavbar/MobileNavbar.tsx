...
import Icons from "@/public/icons/brandIcons";
...
const MobileNavbar = () => {
  ...
  // interface iconTypes {
  //   facebook: React.ElementType;
  //   linkedin: React.ElementType;
  //   twitter: React.ElementType;
  //   github: React.ElementType;
  // }

  // //Destructre the Icons object
  // const { facebook, linkedin, twitter, github }: iconTypes = Icons;

  //use the react icons to render the icons
  const theme = "light";
  return (
    <nav
      className={`${
        theme === "light" ? "bg-bgDark" : "bg-bgLight"
      } bg-transparent dark:bg-gray-900 h-[var(--navbarHeight)] sticky w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600`}
    >
