    ...
    >
      ...
      <div className="space-y-1">
        <FormRowInput
          ...
          className={`${getInputStyle("username")} bg-gray-200 dark:bg-gray-700 dark:text-fontLight text-fontDark dark:caret-fontLight caret-fontDark`}
          onChange={() => {
      ...
      <div className="space-y-1">
        <FormRowInput
          ...
          className={`${getInputStyle("email")} bg-gray-200 dark:bg-gray-700 dark:text-fontLight text-fontDark dark:caret-fontLight caret-fontDark`}
          onChange={() => {
            if (formErrors.email) {
              const newErrors = { ...formErrors };
      ...
      <div className="space-y-1">
        <FormRowTextArea
          ...
          className={`${getInputStyle("message")} bg-gray-200 dark:bg-gray-700 dark:text-fontLight text-fontDark dark:caret-fontLight caret-fontDark`}
          onChange={() => {
